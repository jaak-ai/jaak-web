---
title: Paso 6 - Verificación de identidad vía Android
description: Prueba de vida (liveness) con video en Base64 para confirmar que la persona es real y obtener el bestFrame para la verificación de titularidad.
category: api
order: 7
---
