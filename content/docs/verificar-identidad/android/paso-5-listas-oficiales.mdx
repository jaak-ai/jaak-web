---
title: Paso 5 - Listas oficiales y listas negras vía Android
description: Verificación de los datos del usuario contra listas oficiales (INE, Interpol, OFAC, RENAPO, SAT, CDC) desde Android.
category: api
order: 6
---
