---
title: Paso 4 - Verificación de documento vía API
description: Validar la autenticidad del documento de identidad enviando imágenes en Base64.
category: api
order: 5
---
...
| Campo    | Tipo   | Descripción                                                                                                      |
| :------- | :----- | :--------------------------------------------------------------------------------------------------------------- |
| type     | string | Tipo de documento. [Ver lista](https://docs.jaak.ai/v2.0/docs/lista-de-tipo-de-identificaciones)                 |
...
Después de verificar y validar el documento, se puede proceder a la extracción de datos en el siguiente paso, es importante recordar que las mismas imágenes enviadas en este paso se usaran en el siguiente para buscar tener la mayor coherencia en la Sesión KYC.
