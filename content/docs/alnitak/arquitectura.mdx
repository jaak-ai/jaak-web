...
reales de cada etapa, el `took_ms` total y `slack_ms` — la holgura frente al
objetivo de 400 ms. Se puede ver consulta a consulta si el tiempo se va a
detección, vectorización o búsqueda.
</Callout>
