...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    plans: [
      ...
      {name:"Bronce",  qty:"50 sesiones",  price:"$2,625",  link:"https://platform.jaak.ai/#/register/user-info?d="},
      {name:"Plata",   qty:"100 sesiones", price:"$4,725",  link:"https://platform.jaak.ai/#/register/user-info?d="},
      {name:"Oro",     qty:"250 sesiones", price:"$11,594", link:"https://platform.jaak.ai/#/register/user-info?d="},
      {name:"Platino", qty:"500 sesiones", price:"$21,875", link:"https://platform.jaak.ai/#/register/user-info?d="},
    ],
  },
  {
    id: "ine",
