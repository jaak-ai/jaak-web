...
const components = [
  {
    ...
    benefit: "Detecta intentos de fraude sin friccionar al usuario real.",
    useCase: "Prevención de spoofing en onboarding digital a escala.",
    icon: (
    ...
    tag: "Liveness iBeta PAD",
  },
  {
    title: "Validación biométrica 1:1",
    benefit: "Confirma que la persona ante la cámara coincide con el documento oficial.",
    useCase: "Vinculación de identidad en contratos, créditos y cuentas.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    benefit: "Extrae y valida automáticamente datos de IFE/INE, pasaporte y actas.",
    useCase: "Eliminación de captura manual en procesos de alta de clientes.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
      </svg>
    ),
    tag: "IFE · INE · Pasaporte",
  },
  {
    title: "Geolocalización",
    benefit: "Registra dónde ocurrió la verificación como evidencia contextual.",
    useCase: "Auditorías regulatorias que requieren ubicación del proceso.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    benefit: "Valida la vigencia y autenticidad de la credencial ante INE y RENAPO.",
    useCase: "Cumplimiento con Ley Fintech y disposiciones CNBV para identificación.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Listas negras",
    benefit: "Detecta personas en listas de sanciones nacionales e internacionales.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mb-14">
          ...
          >
            ...
            auditable del usuario. No solo verificas: generas un registro defendible.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <span
                  ...
                  style={{
                    background: "rgba(42,215,150,0.10)",
