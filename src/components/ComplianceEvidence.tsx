    ...
    <section className="py-24 bg-[#111111]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Legal defense line */}
          <p className="text-lg text-[#00d4aa] font-medium mb-10">
          ...
          <div className="flex flex-wrap gap-3">
            <span className="px-4 py-2 bg-white/5 text-white/80 text-sm font-medium rounded-lg border border-white/10">
              ISO 27001
            </span>
            <span className="px-4 py-2 bg-white/5 text-white/80 text-sm font-medium rounded-lg border border-white/10">
              ISO 9001
