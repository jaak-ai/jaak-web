    ...
    <section className="section-padding">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0E1133] mb-6">
          ...
          <p className="text-lg text-[#53535B] mb-10 max-w-2xl mx-auto">
            Los deepfakes y la suplantación de identidad están transformando la manera en que operan los fraudes en línea.
          </p>
