    ...
    >
      ...
      >
        <p className="text-gray-700 leading-relaxed">
          <strong className="text-amber-800">Lo que no siempre se dice:</strong> un expediente digital incompleto puede ser peor que ninguno. Porque crea la ilusión de cumplimiento sin la sustancia que lo respalda.
        </p>
      </div>
      ...
      >
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs mb-3" style={{ color: "rgba(107,114,128,0.8)" }}>
      ...
      <div className="mb-10">
        ...
        <ol className="space-y-2 text-sm text-gray-700 list-decimal list-inside">
          <li>
            CONDUSEF, Supervisión 2025 — Crédito de habilitación o avío en uniones de crédito (mayo 2026)
          </li>
          <li>
            El Economista / Yahoo Noticias, &ldquo;Cuotas de supervisión de la CNBV pegan a uniones de crédito en 2026&rdquo; (marzo 2026)
          </li>
          <li>
            Gaceta del Semanario Judicial de la Federación, Tesis I.2o.C.38 C (11a.) y I.11o.C.82 C (11a.), Libro 2, Tomo IV (octubre 2025)
          </li>
          <li>
