...
export default function DisposicionesCNBV() {
  return (
    <ArticleLayout
      title="Guía completa de las disposiciones CNBV para verificación de identidad"
      subtitle="Un análisis detallado de los requisitos de la Comisión Nacional Bancaria y de Valores para el proceso de identificación de clientes. Conoce las obligaciones específicas y cómo cumplirlas de manera eficiente."
      category="Regulación"
      ...
      imageAlt="Guía de disposiciones CNBV para verificación de identidad en México"
      jsonLd={jsonLd}
      relatedPosts={[
