...
export const metadata: Metadata = {
  title: "Cumplimiento Regulatorio LFPIORPI y Actividades Vulnerables | JAAK",
  description:
    "Cumple con CNBV, LFPIORPI Art. 17, UIF y regulación antilavado. Verificación de identidad para actividades vulnerables: inmobiliarias, vehículos, activos virtuales. Evidencia auditable.",
  keywords: [
  ...
  openGraph: {
    title: "Cumplimiento Regulatorio LFPIORPI | JAAK",
    description: "Verificación de identidad para LFPIORPI, actividades vulnerables Art. 17, y entornos supervisados. Evidencia auditable para UIF.",
    type: "website",
  },
};
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">
                  Cumplimiento de identidad alineado con la LFPIORPI
                </h2>
                <p className="text-xl text-gray-600">
                  JAAK opera bajo principios de cumplimiento exigidos por instituciones financieras y empresas reguladas en México, incluyendo obligaciones derivadas de la Ley Federal para la Prevención e Identificación de Operaciones con Recursos de Procedencia Ilícita (LFPIORPI).
                </p>
                <p className="text-gray-600 mt-4">
                  Nuestro enfoque está diseñado para identificar, verificar y documentar identidades de forma consistente, generando evidencia defendible ante auditorías y revisiones de la autoridad.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-8 mb-12">
                ...
                <p className="text-gray-600 mb-6">
                  El Artículo 17 de la LFPIORPI define las Actividades Vulnerables que, por su naturaleza, están sujetas a obligaciones reforzadas de identificación, verificación y reporte ante la Unidad de Inteligencia Financiera (UIF) cuando se superan ciertos umbrales.
                </p>
                <p className="text-gray-600 mb-8">
                  JAAK permite a las organizaciones que realizan estas actividades cumplir con la identificación de clientes y la conservación de evidencia, facilitando el cumplimiento operativo sin depender de procesos manuales.
                </p>

                {/* Lista de actividades */}
                <div className="mb-8">
                  <h4 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">
                    Actividades comúnmente cubiertas
                  </h4>
                  <div className="grid md:grid-cols-2 gap-3">
                    {[
                      "Juegos, sorteos y concursos",
                      "Compraventa de bienes inmuebles",
                      "Compraventa habitual de vehículos, aeronaves o embarcaciones",
                      "Obras de arte y antigüedades",
                      "Servicios profesionales sujetos a la Ley",
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200">
                  <p className="text-gray-700 font-medium">
                    En todos los casos, el principio es el mismo: identificar correctamente, conservar evidencia y poder demostrar cumplimiento.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-600 mb-6">
                  Cada validación realizada con JAAK genera evidencia legal auditable, alineada con los requerimientos de:
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  {[
                    ...
                    "Procesos de control de instituciones financieras",
                  ].map((item, index) => (
                ...
                <p className="text-gray-600 mt-6">
                  Este es el mismo estándar que exigen banca y fintech regulada.
                </p>
              </div>
              ...
              <div className="bg-[#0a0a0a] rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-2">Aclaración importante</h4>
                    <p className="text-white/60 text-sm">
                      JAAK es una plataforma tecnológica de apoyo al cumplimiento. No sustituye asesoría legal ni determina obligaciones de reporte.
                    </p>
                  </div>
                </div>
              </div>
