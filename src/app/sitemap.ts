...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${baseUrl}/firma-digital-marca-blanca`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    ...
    {
      url: `${baseUrl}/signa/calculadora`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/signa/comparacion`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.85,
    },
    ...
    {
      url: `${baseUrl}/cumplimiento/actividades-vulnerables`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/salud/farmacias`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.75,
    },
    {
      url: `${baseUrl}/salud/telemedicina`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.75,
    },
    ...
    {
      url: `${baseUrl}/salud/software-clinico`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.75,
    },
